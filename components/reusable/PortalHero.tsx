    ...
    <div className="h-[495px] shrink-0 [background:linear-gradient(135deg,rgba(49,46,129,0.95)_0%,rgba(88,28,135,0.95)_50%,rgba(131,24,67,0.95)_100%)] relative">
      <div className="max-w-[1216px] mx-auto relative flex items-center justify-between pt-[182px] z-20">
        <div className="flex flex-col items-start">
          ...
          <h2 className="max-w-[462.3px] mb-2.5 text-6xl font-black leading-[60px] text-white">
            Welcome Back,{" "}
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="text-right">
            <p className="text-[#D1D5DB] text-lg">Next session in</p>
            <h2 className="bg-gradient-to-r from-[#F97316] to-[#EC4899] font-black text-[42px] bg-clip-text text-transparent">
              2 hours
            </h2>
          </div>
        </div>
      ...
      {/* two blobs */}
      <div className="w-[16vw] h-[16vw] shrink-0 [background:rgba(168,85,247,0.20)] blur-[32px] rounded-full absolute left-10 bottom-25 z-10" />
      <div className="w-[20vw] h-[20vw] shrink-0 [background:rgba(59,130,246,0.20)] blur-[32px] rounded-full absolute right-10 bottom-10 z-10" />
    </div>
  );
};
