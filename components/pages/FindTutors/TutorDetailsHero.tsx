...
export default function TutorDetailsHero() {
  return (
    <section className="lg:pt-42 md:pt-40 pt-36  lg:pb-16 md:pb-12 pb-8 shrink-0 [background:linear-gradient(135deg,rgba(49,46,129)_0%,rgba(88,28,135)_50%,rgba(131,24,67)_100%)] relative">
      {/* content */}
      <div className="flex flex-col items-center justify-center relative z-20">
        ...
        <h1 className=" text-4xl shrink-0 text-white text-center font-black lg:leading-[96px] md:leading-[60px]  leading-12 lg:text-8xl mb-1.5  sm:text-3xl md:text-5xl ">
