        ...
        <div className="bg-white border-t border-gray-200 p-6  mx-auto">
          ...
          <div className="flex items-center justify-between  mb-[25px]">
            ...
            <button className="flex items-center space-x-2.5 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              <Download className="w-5 h-5 text-[#141B34]" />
              <span className="text-gray-700">Download Materials</span>
            </button>
          </div>
          ...
          <div className="space-y-6">
            {session.files.map((file, index) => (
              <div
                key={index}
                className="flex items-center gap-2.5 p-3 bg-[#F6F8FA] rounded-[10px] cursor-pointer border-l-2 border-[#6366F1]"
              >
                ...
                <span className="text-[color:var(--B,#070707)] [font-family:Inter] text-base font-normal leading-[160%] tracking-[0.08px]">{file}</span>
              </div>
            ))}
          </div>
        </div>
