...
export default function FAQSection() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: (
        <p>
          Please refer to the Subjects Catalog to find all of the services
          currently being offered on Evolve. The catalog is constantly being
          updated. If you don't see your desired subject, you can sign up to be
          alerted once it is added to the catalog.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <p>
          ...
          high level of proficiency in the subjects they want to teach by
          passing an advanced exam. They are also required to pass a thorough
          background check before they are allowed on the platform.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          We offer a satisfaction guarantee and will work with you to resolve
          any issues or find a better match.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>
            We recommend booking recurring sessions in advance for two reasons:
          </p>
...

    {
      ...
      answer: (
        <p>
          You set your own rates. We believe you should earn what you are worth,
    ...
    },
    {
      ...
      answer: (
        <p>
          You must show proof of identity, pass a proficiency exam for any
          subject you wish to teach, and pass a background check.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <ul className="list-disc ml-6 space-y-1">
          ...
          <li>
            Encourage students to continue learning outside sessions
          </li>
          <li>
            Promote self-discipline to help students stay on track
          </li>
          <li>
          ...
          <li>
            Practice patience and provide supportive instruction
          </li>
        </ul>
      ),
    },
    {
      question: (
        <p className="w-full flex items-center justify-between">
          When do I get paid? <TutorTag />
        </p>
      ),
      answer: (
        <p>
          You get paid the same day for any sessions you complete.
        </p>
      ),
    },
    {
      question: "How does Evolve track student progress?",
      answer: (
        <div className="space-y-3">
          <p>
            Evolve Tutoring has partnered with Synap for all testing features.
          </p>
          <p>
            When a student signs up for a course, they are sent to Synap for a
            knowledge test. This test sets the baseline for progress reports.
          </p>
          <p>
            At the end of each month, the student will take the same knowledge
            test and their results will be compared to their first and previous
            month’s scores.
          </p>
        </div>
      ),
    ...
    {
      question: "What if my session gets cut short?",
      answer: (
        <div className="space-y-3">
          <p>
            If the session is cut short due to a technical issue on the
            platform, Evolve Tutoring will refund the student and pay the tutor
            the full session amount.
          </p>
          <p>
            Session issues caused by factors outside of the platform’s control
