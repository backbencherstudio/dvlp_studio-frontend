        ...
        <div>
          ...
          <div className="flex items-center justify-center gap-5 mt-[51px] px-4 md:px-0">
            <Link href={"/find-tutors"}>
              <button className="flex md:gap-3 items-center cursor-pointer py-4 md:py-[21px] px-5 md:px-[40px] bg-white text-[#003466] text-lg leading-7 rounded-2xl hover:scale-105 transition-transform duration-200
">
                <span>
                  <CurosrIcon />
                </span>
            ...
            <Link href={"/tutor/sign-up"}>
              <button className="flex  gap-3 items-center  bg-gradient-to-r from-cyan-600 to-purple-700 cursor-pointer py-4 md:py-[21px] px-5 md:px-[40px] text-white text-lg leading-7 rounded-2xl bg-white/20 border border-white/30 hover:scale-105 transition-transform duration-200
">
                <span>
